/*
  Reference: https://github.com/Bitcoin-com/bitbox-sdk/blob/master/examples/applications/wallet/create-wallet/create-wallet.js
...
const mnemonic = 'type pepper aunt dragon drift hotel craft agent silly aerobic inhale alcohol'
...
for (let i = 0; i < 10; i++) {
  ...
  console.log(`m/44'/145'/0'/0/${i}: ${bitbox.HDNode.toCashAddress(childNode, true)}`)
  outStr += `m/44'/145'/0'/0/${i}: ${bitbox.HDNode.toCashAddress(childNode, true)}\n`
